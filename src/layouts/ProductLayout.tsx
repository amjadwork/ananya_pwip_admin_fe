      ...
      >
        <Container>
          <Routes>
            ...
            />
            <Route
              path="/products/ec/ec-products"
              element={<ProductsContainer />}
            />
            <Route
              path="/products/ec/ec-products/:id"
              element={<ManageProductsContainer />}
            />
            <Route
              path="/products/ec/locations/"
              element={<LocationsContainer />}
            />
            <Route path="/products/ec/cha" element={<ManageChaContainer />} />
            <Route path="/products/ec/Shl" element={<ManageShlContainer />} />
            <Route
